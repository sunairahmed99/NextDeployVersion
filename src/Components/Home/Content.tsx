...
export default function Content() {
  ...
  const getdata =async ()=>{
    try{
        ...
        let response = await axios.get('https://next-deploy-version-qpkryqyz3-sunair-ahmeds-projects.vercel.app/api/HomeBlog')
...
const catdata =async ()=>{
  try{
      ...
      let response = await axios.get('https://next-deploy-version-qpkryqyz3-sunair-ahmeds-projects.vercel.app/api/Category/')
