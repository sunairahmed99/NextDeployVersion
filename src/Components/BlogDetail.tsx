  ...
  return (
    ...
    <div className='grid grid-cols-1 lg:grid-cols-5'>

        {
            ...
            <Image src={getblogs.image} alt="" className='w-full mt-[30px] lg:m-[40px] h-[300px]  lg:w-[700px] lg:h-[470px] border border-blue-300 rounded-lg' height={300} width={300}  priority/>
